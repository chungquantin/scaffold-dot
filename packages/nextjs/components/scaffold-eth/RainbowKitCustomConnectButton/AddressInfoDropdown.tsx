  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary className="btn btn-secondary btn-sm px-2 py-1 shadow-md dropdown-toggle gap-0 h-auto!">
        ...
        <ul className="dropdown-content menu z-2 p-2 mt-2 shadow-center bg-base-200 rounded-box gap-1">
